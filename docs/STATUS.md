...
- Public [GitHub repository](https://github.com/josepha-mayo/cutover) and passing [Windows/Ubuntu CI](https://github.com/josepha-mayo/cutover/actions/runs/35870846290) on Python 3.12.
...
- A reference-withheld Bob repair workspace was prepared as sibling `cutover-bob-session-62bea5b9` from committed Git blobs at `62bea5b9`. The verifier matched all 18 copied files to that historical commit, confirmed the passing reference plans were absent, and recorded evaluator SHA-256 `fc2e487d555e723b5500e06346eaad3ceee220954ee9ebd7ba7674aaf887f774`. Its late bridge blocks at 108/124. This snapshot predates engine v0.2.3; do not use it for the event session. The older `c1395b51` workspace used Windows-converted JSON line endings and fails the strict committed-byte audit. Re-freeze from the final pre-kickoff commit. This is pre-event setup, not a Bob session.
