...
`.github/workflows/cutover-review.yml`, files under `ci/`, a focused
`tests/test_ci_gate.py`, and `docs/CI.md`. Do not edit the engine, fixtures,
existing tests, or Bob repair candidate. Do not push or publish anything.
