...
The later presentation finalizer is pre-event Codex preparation too. Record the last pre-kickoff commit hash here when the event opens; do not attribute any pre-kickoff commits to Bob.
