...
Open the Cutover project in IBM Bob, connect the prepared project-local MCP server, and choose the Cutover release engineer mode. Begin a new task:
...
- JSON reports from rerunning its final candidate in the CLI and the browser.
